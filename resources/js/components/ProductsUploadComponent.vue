        ...
        <form class="flex flex-col items-center" action="/products" method="post" enctype="multipart/form-data">
            <div class="p-3">
                ...
                <div class="p-3  mt-2 text-center space-x-4 md:block">
                    ...
                    <button
                        class="mb-2 md:mb-0 bg-teal-400 border border-teal-500 px-5 py-2 text-sm shadow-sm font-medium tracking-wider text-white rounded-full hover:shadow-lg hover:bg-teal-4000">Load</button>
                </div>
            </div>
        </form>
    </div>
...
<script>
    export default {
        mounted() {
            console.log('ProductsUploadComponent mounted')
        }
    }
</script>

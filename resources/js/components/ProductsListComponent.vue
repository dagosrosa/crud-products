						...
						<td colspan="6">
							<div class="flex justify-center items-center font-semibold p-3 space-x-1">
								...
								<span>No data to display.</span>
									<a href="#" class="inline-block text-sm px-4 py-2 leading-none text-teal-400 border-teal-400 hover:border-transparent hover:text-teal hover:bg-white lg:mt-0">Load your products file!</a>
							</div>
						</td>
					</tr>
				</tbody>
